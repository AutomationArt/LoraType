...
#define myLog_n(format, ...) log_printf(MYLOG_LOG_FORMAT(N, format), ##__VA_ARGS__)
#define myIsr_log_n(format, ...) ets_printf(MYLOG_LOG_FORMAT(N, format), ##__VA_ARGS__)
#else
